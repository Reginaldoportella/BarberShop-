...
export function Barbers() {
  return (
    <section id="barbeiros" className="bg-barber-light py-20 text-barber-darkText sm:py-28">
      <div className="section-shell">
        <div className="text-center">
          ...
          <p className="mx-auto mt-7 max-w-2xl text-base leading-7 text-barber-subtle">
        ...
        <div className="mt-14 grid gap-8 lg:grid-cols-[0.85fr_1.15fr] lg:items-start">
          <div className="relative overflow-hidden bg-barber-card">
            <Image
              ...
              >
                <div className="flex items-start justify-between gap-6">
                  <div>
                    ...
                    <p className="mt-3 leading-7 text-barber-subtle">{barber.specialty}</p>
                  </div>
                  <span className="shrink-0 text-sm font-bold uppercase tracking-[0.2em] text-barber-subtle">
                    {barber.experience}
                  </span>
                </div>
              </article>
