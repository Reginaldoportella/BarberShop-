export function Contact() {
  return (
    <section id="contato" className="bg-white pb-20 text-black sm:pb-28">
      <div className="section-shell">
        ...
        <div className="mx-auto mt-14 grid max-w-4xl gap-8 text-center md:grid-cols-3">
          {[
            ...
            <div key={title}>
              <div className="mx-auto grid size-14 place-items-center rounded-full bg-barber-gold text-xl font-black text-white">
                +
              </div>
