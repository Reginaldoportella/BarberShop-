...
export function Services() {
  return (
    <section id="servicos" className="bg-barber-black py-20 sm:py-28">
      <div className="section-shell">
        <div className="relative min-h-[520px] overflow-hidden">
          ...
          <div className="relative flex min-h-[520px] items-center justify-center px-4 text-center">
            <div>
              <h2 className="max-w-4xl text-4xl font-black leading-[0.95] tracking-[-0.03em] text-barber-cream sm:text-6xl">
        ...
        <div className="mt-14 grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          {services.map((service) => (
            <article
              key={service.name}
              className="premium-card-motion border border-barber-ash bg-barber-graphite p-6 hover:border-barber-gold/60"
            >
              <p className="luxury-label">{service.duration}</p>
              <h3 className="mt-5 text-2xl font-semibold text-barber-cream">
                {service.name}
              </h3>
